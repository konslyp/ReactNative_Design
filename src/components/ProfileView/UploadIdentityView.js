...
export default class UploadIdentityView extends Component {
      ...
      <View style={{flex:1}}>
          <View style={{flex:1}}>
            <ScrollView style={{marginBottom:60}}>
                ...
                <Text style={[CommonStyles.medium18,{fontWeight:'bold',marginTop:10,color:'rgb(106,106,106)',fontSize:18,flex:1,textAlign:'center'}]}>Upload identity documents</Text>
                <Text style={[CommonStyles.book,{margin:15,color:'rgb(106,106,106)',fontSize:14,flex:1,textAlign:'center'}]}>
                  To make sure everyone on 2Hats is provided with the best service experience we require all service providers to provide atleast one form of ID. You can upload multiple forms of ID.
                </Text>
